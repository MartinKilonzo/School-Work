            ...
            if depth == self.depth or state.isWin() or state.isLose():
                ...
                for action in state.getLegalActions():
                    if action != Directions.STOP:
                        ...
                        successorScore = beta(state.generateSuccessor(0, action), depth, 1)
                ...
                for action in state.getLegalActions(player):
                    if action != Directions.STOP:
                        ...
                        if player == state.getNumAgents() - 1:
                            successorScore = alpha(state.generateSuccessor(player, action), depth)
                        else:
                            successorScore = beta(state.generateSuccessor(player, action), depth, player + 1)
