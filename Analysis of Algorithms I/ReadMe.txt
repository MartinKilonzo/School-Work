...
* Assignment 3 contains the Java program PrimHeap, which uses a min-priority heap as defined in Heap.java, and vertexes as defined in Vertex.java, to create an edge map given an input text file and find the minimum spanning tree using Prim's MST algorithm.
