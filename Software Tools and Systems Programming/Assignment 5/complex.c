...
struct complex_t multiply(struct complex_t a, struct complex_t b);
struct complex_t* divide(struct complex_t *a, struct complex_t *b);

int main (void)
{
	struct complex_t a, b, product, *quotient;
...
struct complex_t multiply(struct complex_t a, struct complex_t b)
{
	struct complex_t complexProduct;
...
struct complex_t* divide(struct complex_t *a, struct complex_t *b)
{
	struct complex_t *complexQuotient = malloc(sizeof(struct complex_t));
